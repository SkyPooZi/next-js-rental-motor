                        ...
                        <div className="mb-4 flex flex-col justify-between gap-4">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="skipo@gmail.com" type="email" value="skipo tzy" />
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan No Telp" type="number" value="081234567" />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Akun Sosmed
                                    </span>
                                    <Input label="Masukkan akun sosmed" value="@zein_wx" />
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Textarea label="Masukkan alamat lengkap" value="Desa. Besito, Kecamatan. Gebog, Kabupaten. Kudus, Provinsi. Jawa Tengah, Negara. Indonesia 59234" />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Penyewa
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan nama motor" value="NMAX" />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Tanggal Booking
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Textarea label="Masukkan keperluan menyewa" value="Saya ingin berlibur di daerah Kudus" />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Penerimaan Motor
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan nama kontak darurat" value="Abdul" />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Nomor Kontak Darurat
                                    </span>
                                    <Input label="Masukkan nomor kontak darurat" type="number" value="081234567" />
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan Hubungan Dengan Kontak Darurat" value="Saudara" />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Diskon
                                    </span>
                                    <Select label="Masukkan diskon">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan total pembayaran" type="number" value="175000" />
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">

...
import { IoSettings, IoReorderThreeOutline, IoReorderThree } from "react-icons/io5";
...
export default function NavbarAdmin() {
    ...
    return (
        <div className="flex items-center">
            <div className="middle none font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-gray-500 hidden items-center gap-1 px-4 xl:flex" type="button">
            ...
            <div className="relative middle none font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs text-gray-500 grid xl:hidden" type="button">

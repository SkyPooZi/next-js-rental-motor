                        ...
                        <div className="mb-4 flex flex-col justify-between gap-4">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan nama motor" value="Vario" disabled />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Tipe
                                    </span>
                                    <Select label="Masukkan tipe motor" disabled>
                                        <Option className="rounded-md w-full">
                                            Matic
                                        </Option>
                                        <Option className="my-2 rounded-md w-full">
                                            Manual
                                        </Option>
                                    </Select>
                                </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan merk motor" value="Honda" disabled />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Stok
                                    </span>
                                    <Input label="Masukkan stok motor" type="number" value="2" disabled />
                                    <Typography
                                        variant="small"
                                        color="gray"
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan harga motor" type="number" disabled />
                                    <Typography
                                        variant="small"
                                        color="gray"
                                        className="flex items-center gap-1 font-normal"
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Textarea label="Masukkan fasilitas tambahan" disabled />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">

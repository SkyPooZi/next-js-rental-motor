...
export default function DetailDiscount() {
            ...
            <nav className="block w-full max-w-full bg-transparent text-white shadow-none rounded-xl transition-all px-0 py-1">
                <div className="flex flex-col-reverse justify-between gap-1 md:flex-row md:items-center">
                    <div className="capitalize">
                        ...
                        <h6 className="block antialiased tracking-normal text-base font-semibold leading-relaxed text-gray-900 mt-2">Detail Diskon</h6>
                    </div>
                    <NavbarAdmin />
                </div>
            </nav>
                        ...
                        <div className="mb-4 flex flex-col justify-between gap-4">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan nama diskon" value="Ramadhan" disabled />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Potongan Harga
                                    </span>
                                    <Input label="Masukkan potongan harga" value="30%" disabled />
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Textarea label="Masukkan periode diskon" value="12 Maret 2024 - 10 April 2024" disabled />
                                </div>
                            </div>
                            <div>
                                <button

                        ...
                        <div className="mb-4 flex flex-col justify-between gap-4">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan nama Lengkap" value="skipo tzy" disabled />
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan email" type="email" value="skipo@gmail.com" disabled />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Nomor HP
                                    </span>
                                    <Input label="Masukkan nomor HP" type="number" value="0812345678" disabled />
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Textarea label="Masukkan alamat lengkap" value="Kudus" disabled />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Peran

...
import { RatingTable } from "@/components/sub/admin/ratingTable";

export default function Rating() {
    const [activeComponent, setActiveComponent] = useState("rating");
                    ...
                    <nav className="block w-full max-w-full bg-transparent text-white shadow-none rounded-xl transition-all px-0 py-1">
                        <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
                            <div className="capitalize">
                                ...
                                <h6 className="block antialiased tracking-normal text-base font-semibold leading-relaxed text-gray-900">Ulasan</h6>
                            </div>
                            <div className="flex">

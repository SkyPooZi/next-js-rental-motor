                        ...
                        <div className="mb-4 flex flex-col justify-between gap-4">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <Input label="Masukkan nama diskon" />
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Potongan Harga <span className="text-[#FF4D33] font-semibold">*</span>
                                    </span>
                                    <Input label="Masukkan potongan harga" />
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full flex flex-col gap-2">
                                    <span className="text-black">
                                        Periode <span className="text-[#FF4D33] font-semibold">*</span>
                                    </span>
                                    <Textarea label="Masukkan periode diskon" />
                                </div>
                            </div>
                            <div>
                                <button

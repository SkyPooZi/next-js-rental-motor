...
import { HistoryChangeDataTable } from "./historyChangeDataTable";

export default function HistoryChangeData() {
    const [activeComponent, setActiveComponent] = useState("historyChangeData");
                            ...
                            <nav aria-label="breadcrumb" className="w-max">
                                <ol className="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
                                    ...
                                    <li className="flex items-center text-blue-900 antialiased text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-blue-500">
                                        <p className="block antialiased text-sm leading-normal font-normal text-[#1E3A8A]">Riwayat Ubah Data</p>
                                    </li>
                                </ol>
                            </nav>
                            <h6 className="block antialiased tracking-normal text-base font-semibold leading-relaxed text-gray-900">Riwayat Ubah Data</h6>
                        </div>
                        <div className="flex">

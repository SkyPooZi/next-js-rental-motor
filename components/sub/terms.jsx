    ...
    return (
        <div className="flex flex-col gap-5 py-5 px-5 bg-white rounded-md">
            ...
            <Label>
                <span className="leading-5">
                    1. Informasi Pribadi :
                    Saat Anda melakukan pemesanan atau membuat akun, kami dapat mengumpulkan informasi pribadi seperti nama Anda, alamat email, nomor telepon, dan informasi pembayaran.
                </span>
            </Label>
            <Label>
                <span className="leading-5">
                    2. Informasi Penggunaan :
                    Kami mengumpulkan informasi tentang bagaimana Anda berinteraksi dengan situs web kami, seperti alamat IP, jenis browser, halaman yang dikunjungi, dan waktu kunjungan.
                </span>
            </Label>
            <Label>
                <span>
            ...
            <Label>
                <span className="leading-5">
                    1. Pemesanan dan Layanan :
                    Kami menggunakan informasi pribadi Anda untuk memproses pemesanan, menyediakan layanan sewa, dan berkomunikasi dengan Anda tentang reservasi Anda.
                </span>
            </Label>
            <Label>
                <span className="leading-5">
                    2. Meningkatkan Layanan Kami :
                    Kami menganalisis data penggunaan untuk meningkatkan situs web kami, layanan, dan pengalaman pelanggan.
                </span>
            </Label>
            <Label>
                <span className="leading-5">
                    3. Pemasaran :
                    Dengan persetujuan Anda, kami dapat mengirimkan email promosi tentang penawaran khusus, diskon, dan layanan baru.
                </span>
            </Label>
            <Label>
                <span>

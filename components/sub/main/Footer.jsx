...
export default function Footer() {
    ...
    return (
        <footer className="bg-white">
            <div className="lg:mx-view-pc max-w-screen-xl px-4 mb-24 md:mb-0 pb-6 pt-10 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center items-center gap-2 text-[#FF4D33] sm:justify-start">
                            <Image src='/images/logo.png' alt='Logo' width='55' height='55' className='cursor-pointer  md:w-auto' />
                        ...
                        <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                            Rental Motor Terpercaya di Kudus. Kami menyediakan berbagai jenis motor dengan harga terjangkau.
                        </p>
                        ...
                        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                            <li>
                                <a
                                    ...
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-[#FF4D33] transition hover:text-[#FF4D33]/75"
                                >
                ...
                <div className="mt-8 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        <p className="text-sm text-gray-500">
                            ...
                            <a
                                className="inline-block text-[#FF4D33] underline transition hover:text-[#FF4D33]/75"
                                href="#"
                            >
                                Terms & Conditions
                            </a>

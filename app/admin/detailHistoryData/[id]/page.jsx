...
import HistoryDataDetail from '@/components/sub/historyDataDetail';
import { fetchHistoryDetail } from '@/utils/services/fetchHistoryDetail';
...
const Page = ({ params: { id } }) => {
    ...
    useEffect(() => {
        const loadHistoryDetail = async () => {
            const result = await fetchHistoryDetail(id, token);
                ...
                <div className="block p-4 xl:ml-80">
                    ...
                    <div className="mt-12">
                        {error ? (
                            ...
                            <HistoryDataDetail history={history} />
                        ) : (
                            <p>Loading...</p>
                        )}
                    </div>

...
import EditPrice from '@/components/sub/admin/editPrice';
...
const Page = ({ params: { id } }) => {
    ...
    const [harga_motor_diantar, setHargaMotorDiantar] = useState('');
    ...
    useEffect(() => {
        const loadMotorDetail = async () => {
            ...
            if (result.error) {
                ...
                setHargaMotorDiantar(motorData.harga_motor_diantar); // Initialize harga_motor_diantar state
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMotor((prevMotor) => ({
                ...
                ...(harga_motor_diantar && { harga_motor_diantar: data.listMotor.harga_motor_diantar }),
                    ...
                    <div className="mt-12">
                        {error ? (
                            ...
                            <EditPrice
                                ...
                                loading={loading}
                                harga_motor_diantar={harga_motor_diantar}
                                setHargaMotorDiantar={setHargaMotorDiantar}
